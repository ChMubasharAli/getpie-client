...
import { ChevronDown, Heart, Menu, Zap } from "lucide-react";
import { useState } from "react";
import { BackgroundImage, Text } from "@mantine/core";

export default function TemplateTwo({ formData = {}, isPreview = false }) {
  ...
  const businessName = formData.businessName || "Explore Dimensions";
  const description =
  ...
  return (
    <div className="min-h-screen bg-slate-100 relative overflow-x-hidden font-DmSans">
      ...
      <BackgroundImage
        src={"/spatial/heroBackgroundImage.jpg"}
        className="py-24  relative flex items-center ` justify-center overflow-hidden"
      >
          ...
          <div className="max-w-7xl mx-auto p-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center  py-2">
              ...
              <nav className="hidden md:flex space-x-8">
                <a
                  href="#FOOD-HEADER"
                  className="font-DmSans text-white hover:text-gray-200"
                >
                  Home
                </a>
                <a
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-tight font-QuickSand">
            ...
            <div className="mt-8 lg:mt-0">
              <div className="bg-white/90 p-6 md:p-8 rounded-2xl shadow-xl border border-purple-100">
                <div className="space-y-6">
                  <div className="text-center space-y-2">
                    <h3 className="text-xl md:text-2xl font-bold text-blue-900 font-QuickSand">
                      Let's Connect
                    </h3>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <input
                        ...
                        className="rounded-xl h-12 border border-blue-900 px-4 text-[#334155] placeholder:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-900 font-DmSans"
                      />
                      <input
                    ...
                    <input
                      placeholder="Email"
                      className="w-full rounded-xl h-12 border border-blue-900 px-4 text-[#334155] placeholder:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-900 font-DmSans"
                    />
                    <textarea
                      placeholder="Your Message"
                      className="w-full rounded-xl min-h-[100px] border border-blue-900 py-3 text-[#334155] placeholder:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-900 resize-none font-DmSans"
                    />
                    <button className="w-full h-12 rounded-xl bg-blue-900 hover:bg-blue-950 cursor-pointer text-white font-semibold transition-colors font-DmSans">
                      Send Message
                    </button>
                  </div>
                </div>
      ...
      <section
        id="about"
        className={`relative py-12 ${isPreview ? "filter blur-sm" : ""}`}
      >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-6">
                      <div className="bg-white p-6 rounded-3xl shadow-lg">
                        <Zap className="w-12 h-12 text-blue-700 mb-4" />
