...
export default function TemplateSix() {
  ...
  return (
    <>
      ...
      <div className="h-screen bg-gray-900 relative overflow-hidden">
        ...
        <main className="relative z-10 h-full  flex flex-col justify-center items-center  px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="max-w-5xl ">
            ...
            {/* Main Heading */}
            <h1 className="font-QuickSand text-white text-3xl md:text-5xl lg:text-6xl 2xl:text-7xl font-bold  leading-normal mb-12 lg:mb-16">
      ...
      <section className="bg-green-500 py-16 lg:py-24">
      ...
      <section className="bg-gray-900  py-16 lg:py-24 relative">
        {/* Background Pattern */}
        <div
      ...
      {/* Portfolio Grid */}
      <div className="grid grid-cols-1 -mt-24 md:grid-cols-2 gap-x-1 px-2  max-w-6xl mx-auto">
        {/* left side  */}
      ...
      <footer className="bg-gray-900 py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
